...
BACKUP_VAULT_NAME="SSMPatching"          # Change to your vault name
IAM_ROLE_ARN="arn:aws:iam::030332409480:role/service-role/AWSBackupDefaultServiceRole"  # IAM role used for backup
